 ...
 * Must be defined in Render Environment Variables
 * Example:
...
if (!API_BASE_URL) {
  throw new Error('❌ VITE_API_BASE_URL is not defined. Check Render environment variables.');
}
      ...
      <div className="max-w-xl w-full bg-zinc-900 border border-zinc-800 rounded-[3rem] overflow-hidden shadow-2xl relative">
        ...
        <div className="p-12">
          ...
          <button
            ...
            className="w-full py-5 rounded-3xl font-black text-lg bg-white text-black uppercase tracking-widest shadow-2xl transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3 disabled:opacity-50"
          >
